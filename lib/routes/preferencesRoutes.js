...
module.exports = function (rootPath) {
  ...
  return {
    ...
    // 获取学习规则
    'GET /api/v1/preferences/rules': (req, res, _params) => {
    ...
    // 清除学习规则
    'DELETE /api/v1/preferences/rules': (req, res, _params) => {
      learner.reset();
      res.writeHead(204);
      res.end();
    },
    ...
    // 获取格式化偏好提示词
    'GET /api/v1/preferences/format': (req, res, _params) => {
    ...
    // 获取统计信息
    'GET /api/v1/preferences/stats': (req, res, _params) => {
      const stats = learner.getStats();
      res.writeHead(200);
      res.end(
        JSON.stringify({
    ...
    // 导出偏好
    'GET /api/v1/preferences/export': (req, res, _params) => {
