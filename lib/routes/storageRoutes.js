...
module.exports = function(rootPath) {
  ...
  return {
    // 人设
    'GET /api/v1/storage/personas': (req, res, params) => {
  ...
  // 风格
  'GET /api/v1/storage/styles': (req, res, params) => {
  ...
  // 设置
  'GET /api/v1/storage/settings': (req, res, params) => {
  ...
  // 备份
  'POST /api/v1/storage/backup': (req, res, params) => {
    const backup = storage.createBackup();
    res.writeHead(201);
    res.end(JSON.stringify({ success: true, backup }));
  },

  'GET /api/v1/storage/backup': (req, res, params) => {
    const backups = storage.listBackups();
    res.writeHead(200);
    res.end(JSON.stringify({ success: true, backups: backups || [], count: (backups || []).length }));
  },
  ...
  // 导出
  'GET /api/v1/storage/export': (req, res, params) => {
