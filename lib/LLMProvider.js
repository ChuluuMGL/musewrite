...
#AIWriter #Mock`;
  ...
  static listProviders() {
    return [
      { name: 'ollama', type: '本地', free: true, env: null },
      { name: 'openai', type: '云端', free: false, env: 'OPENAI_API_KEY' },
      { name: 'claude', type: '云端', free: false, env: 'ANTHROPIC_API_KEY' },
      { name: 'zhipu', type: '云端', free: false, env: 'ZHIPU_API_KEY' },
      { name: 'deepseek', type: '云端', free: false, env: 'DEEPSEEK_API_KEY' },
      { name: 'volcengine', type: '云端', free: false, env: 'VOLCENGINE_API_KEY' },
      { name: 'gemini', type: '云端', free: false, env: 'GOOGLE_API_KEY' }
    ];
  }
}
