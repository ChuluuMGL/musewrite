...
class ImageGenerator {
  constructor(options = {}) {
    this.config = {
      apiKey:
        options.apiKey || process.env.SEEDDREAM_API_KEY || 'deda9c4c-8935-4062-8e13-bedf9de66239',
  ...
  buildPrompt(title, platform, style = 'modern minimalist') {
    const basePrompts = {
      xiaohongshu:
        'vertical portrait composition 3:4 aspect ratio, content centered, no cropping needed, high quality, professional design',
      wordpress:
        'horizontal landscape composition 16:9 aspect ratio, content centered, header image style, high quality, professional design'
    };
