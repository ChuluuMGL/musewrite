...
describe("CreatorTwin", () => {
  ...
  describe("从历史学习", () => {
    test("应该分析句子长度", async () => {
      const articles = [{content: "这是一篇测试文章。句子不长。短句为主。节奏明快。"}]
    ...
    test("应该分析Emoji使用", async () => {
      const articles = [{content: "这是一篇文章 ✅ 包含一些emoji 🚀 还有更多 💡✨🎉"}]
    ...
    test("应该提取标志性短语", async () => {
      const articles = [{content: "简洁高效是核心。简洁高效很重要。简洁高效。"}]
  ...
  describe("风格注入", () => {
    test("应该生成风格注入Prompt", async () => {
      const articles = [{content: "这是一篇短句文章。节奏很快。简洁明了。✅"}]
      await twin.learnFromHistory(articles)
  ...
  describe("指纹摘要", () => {
    test("应该生成指纹摘要", async () => {
      const articles = [{content: "短句文章。简洁。明了。"}]
      await twin.learnFromHistory(articles)
  ...
  describe("偏好预测", () => {
    test("应该基于指纹预测偏好", async () => {
      const articles = [{content: "短句。快速。简洁。✅🚀"}]
      await twin.learnFromHistory(articles)
